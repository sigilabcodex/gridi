...
const MODE_CONTROL_REGISTRY: Record<Mode, TriggerModeControlSpec[]> = {
  ...
  gear: [
    ...
    },
    {
      ...
      step: 1,
      integer: true,
      tooltip: "Shift the shared tooth-contact phase offset across rings.",
    },
    {
      label: "Ratio",
      key: "subdiv",
      ...
      step: 1,
      integer: true,
      tooltip: "Scale inter-ring tooth ratios against the base ring.",
    },
    {
      label: "Mesh",
      key: "determinism",
      ...
      max: 1,
      step: 0.001,
      tooltip: "Tighten or relax trigger acceptance at ring engagements.",
    },
    {
      label: "Drift",
      key: "weird",
  ...
  radar: [
    ...
    },
    {
      ...
      max: 1,
      step: 0.001,
      tooltip: "Increase moving-target drift speed and scan jitter.",
    },
    {
      label: "Lock",
      key: "determinism",
...
export function renderTriggerSurface(
  ...
  const modeSelector = createModuleIdentitySelector({
    ...
    tooltip: "Select the active generator mode for this module.",
    attachTooltip,
    minWidth: 190,
    maxWidth: 250,
    onOpen: closeRoutingPanel,
  });
  const generatorButton = modeSelector.button;
  identity.append(generatorButton);
  ...
  metaRow.append(seedGroup, routingChip);
