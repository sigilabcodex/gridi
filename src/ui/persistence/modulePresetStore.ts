...
function starterModulePresets() {
  ...
  const drumFactory: Array<ModulePresetRecord | null> = [
    buildFactoryPreset("factory-drum-deep-kick", makeSound("drum", 0), "Deep Kick", { amp: 0.2, basePitch: 0.23, attack: 0.12, decay: 0.52, transient: 0.46, snap: 0.18, noise: 0.06, bodyTone: 0.34, driveColor: 0.34, pitchEnvAmt: 0.68, pitchEnvDecay: 0.24, bendDecay: 0.32, tone: 0.3, comp: 0.38, boost: 0.4, boostTarget: "body", stereoWidth: 0.22 }, factoryTimestamp),
    buildFactoryPreset("factory-drum-soft-kick", makeSound("drum", 0), "Soft Kick", { amp: 0.16, basePitch: 0.33, attack: 0.24, decay: 0.38, transient: 0.3, snap: 0.12, noise: 0.04, bodyTone: 0.45, driveColor: 0.25, pitchEnvAmt: 0.42, pitchEnvDecay: 0.4, bendDecay: 0.48, tone: 0.44, comp: 0.22, boost: 0.12, boostTarget: "body", stereoWidth: 0.18 }, factoryTimestamp),
    buildFactoryPreset("factory-drum-punch-kick", makeSound("drum", 0), "Punch Kick", { amp: 0.2, basePitch: 0.4, attack: 0.1, decay: 0.3, transient: 0.84, snap: 0.62, noise: 0.11, bodyTone: 0.58, driveColor: 0.6, pitchEnvAmt: 0.56, pitchEnvDecay: 0.2, bendDecay: 0.26, tone: 0.56, comp: 0.52, compThreshold: 0.38, compRatio: 0.72, compAttack: 0.12, compRelease: 0.34, boost: 0.34, boostTarget: "attack", stereoWidth: 0.24 }, factoryTimestamp),
    buildFactoryPreset("factory-drum-click-kick", makeSound("drum", 0), "Click Kick", { amp: 0.18, basePitch: 0.5, attack: 0.03, decay: 0.24, transient: 0.92, snap: 0.88, noise: 0.15, bodyTone: 0.44, driveColor: 0.68, pitchEnvAmt: 0.48, pitchEnvDecay: 0.14, bendDecay: 0.18, tone: 0.62, comp: 0.58, boost: 0.5, boostTarget: "attack", stereoWidth: 0.2 }, factoryTimestamp),
    buildFactoryPreset("factory-drum-sub-kick", makeSound("drum", 0), "Sub Kick", { amp: 0.24, basePitch: 0.12, attack: 0.22, decay: 0.6, transient: 0.22, snap: 0.08, noise: 0.02, bodyTone: 0.26, driveColor: 0.2, pitchEnvAmt: 0.24, pitchEnvDecay: 0.54, bendDecay: 0.58, tone: 0.2, comp: 0.22, boost: 0.52, boostTarget: "body", stereoWidth: 0.12 }, factoryTimestamp),
    buildFactoryPreset("factory-drum-noisy-kick", makeSound("drum", 0), "Noisy Kick", { amp: 0.19, basePitch: 0.46, attack: 0.08, decay: 0.42, transient: 0.7, snap: 0.62, noise: 0.55, bodyTone: 0.52, driveColor: 0.76, pitchEnvAmt: 0.5, pitchEnvDecay: 0.24, bendDecay: 0.28, tone: 0.64, comp: 0.46, boost: 0.36, boostTarget: "air", stereoWidth: 0.42 }, factoryTimestamp),
    buildFactoryPreset("factory-drum-tom-like", makeSound("drum", 0), "Tom Like", { amp: 0.18, basePitch: 0.56, attack: 0.18, decay: 0.48, transient: 0.36, snap: 0.22, noise: 0.08, bodyTone: 0.7, driveColor: 0.4, pitchEnvAmt: 0.34, pitchEnvDecay: 0.46, bendDecay: 0.52, tone: 0.62, comp: 0.28, boost: 0.18, boostTarget: "body", stereoWidth: 0.3 }, factoryTimestamp),
    buildFactoryPreset("factory-drum-snare-like", makeSound("drum", 0), "Snare Like", { amp: 0.16, basePitch: 0.62, attack: 0.06, decay: 0.44, transient: 0.78, snap: 0.66, noise: 0.72, bodyTone: 0.58, driveColor: 0.64, pitchEnvAmt: 0.24, pitchEnvDecay: 0.32, bendDecay: 0.34, tone: 0.56, comp: 0.5, boost: 0.4, boostTarget: "attack", stereoWidth: 0.58 }, factoryTimestamp),
    buildFactoryPreset("factory-drum-hat-like", makeSound("drum", 0), "Hat Like", { amp: 0.11, basePitch: 0.82, attack: 0.02, decay: 0.14, transient: 0.82, snap: 0.78, noise: 0.94, bodyTone: 0.78, driveColor: 0.74, pitchEnvAmt: 0.12, pitchEnvDecay: 0.12, bendDecay: 0.16, tone: 0.8, comp: 0.34, boost: 0.44, boostTarget: "air", stereoWidth: 0.86 }, factoryTimestamp),
    buildFactoryPreset("factory-drum-metallic-tick", makeSound("drum", 0), "Metallic Tick", { amp: 0.12, basePitch: 0.9, attack: 0.01, decay: 0.1, transient: 0.94, snap: 0.86, noise: 0.6, bodyTone: 0.84, driveColor: 0.9, pitchEnvAmt: 0.2, pitchEnvDecay: 0.1, bendDecay: 0.1, tone: 0.9, comp: 0.4, boost: 0.6, boostTarget: "air", stereoWidth: 0.72 }, factoryTimestamp),
    buildFactoryPreset("factory-drum-pop-perc", makeSound("drum", 0), "Pop Perc", { amp: 0.15, basePitch: 0.68, attack: 0.04, decay: 0.2, transient: 0.82, snap: 0.68, noise: 0.32, bodyTone: 0.62, driveColor: 0.56, pitchEnvAmt: 0.66, pitchEnvDecay: 0.18, bendDecay: 0.22, tone: 0.68, comp: 0.4, boost: 0.24, boostTarget: "attack", stereoWidth: 0.44 }, factoryTimestamp),
    buildFactoryPreset("factory-drum-distorted-perc", makeSound("drum", 0), "Distorted Perc", { amp: 0.14, basePitch: 0.74, attack: 0.04, decay: 0.28, transient: 0.74, snap: 0.7, noise: 0.48, bodyTone: 0.66, driveColor: 0.96, pitchEnvAmt: 0.32, pitchEnvDecay: 0.18, bendDecay: 0.2, tone: 0.76, comp: 0.68, compThreshold: 0.32, compRatio: 0.8, compAttack: 0.1, compRelease: 0.28, boost: 0.7, boostTarget: "air", stereoWidth: 0.5 }, factoryTimestamp),
  ];

  const synthFactory: Array<ModulePresetRecord | null> = [
    buildFactoryPreset("factory-synth-rubber-bass", makeSound("tonal", 0), "Rubber Bass", { amp: 0.14, waveform: 0.24, coarseTune: 0.16, fineTune: 0.44, attack: 0.01, decay: 0.32, sustain: 0.52, release: 0.28, cutoff: 0.42, resonance: 0.24, glide: 0.14, modDepth: 0.22, modRate: 0.3 }, factoryTimestamp),
    buildFactoryPreset("factory-synth-soft-bass", makeSound("tonal", 0), "Soft Bass", { amp: 0.13, waveform: 0.34, coarseTune: 0.12, fineTune: 0.5, attack: 0.06, decay: 0.42, sustain: 0.58, release: 0.5, cutoff: 0.34, resonance: 0.16, glide: 0.1, modDepth: 0.12, modRate: 0.2 }, factoryTimestamp),
    buildFactoryPreset("factory-synth-bright-pluck", makeSound("tonal", 0), "Bright Pluck", { amp: 0.12, waveform: 0.74, coarseTune: 0.2, fineTune: 0.56, attack: 0.002, decay: 0.22, sustain: 0.2, release: 0.16, cutoff: 0.82, resonance: 0.52, glide: 0.02, modDepth: 0.18, modRate: 0.56 }, factoryTimestamp),
    buildFactoryPreset("factory-synth-muted-pluck", makeSound("tonal", 0), "Muted Pluck", { amp: 0.12, waveform: 0.44, coarseTune: 0.18, fineTune: 0.48, attack: 0.004, decay: 0.2, sustain: 0.14, release: 0.12, cutoff: 0.32, resonance: 0.36, glide: 0.03, modDepth: 0.16, modRate: 0.42 }, factoryTimestamp),
    buildFactoryPreset("factory-synth-lead", makeSound("tonal", 0), "Lead", { amp: 0.15, waveform: 0.68, coarseTune: 0.6, fineTune: 0.5, attack: 0.01, decay: 0.3, sustain: 0.68, release: 0.34, cutoff: 0.68, resonance: 0.34, glide: 0.2, modDepth: 0.22, modRate: 0.48 }, factoryTimestamp),
    buildFactoryPreset("factory-synth-hollow-lead", makeSound("tonal", 0), "Hollow Lead", { amp: 0.13, waveform: 0.9, coarseTune: 0.66, fineTune: 0.46, attack: 0.02, decay: 0.28, sustain: 0.6, release: 0.4, cutoff: 0.56, resonance: 0.62, glide: 0.24, modDepth: 0.28, modRate: 0.4 }, factoryTimestamp),
    buildFactoryPreset("factory-synth-drone", makeSound("tonal", 0), "Drone", { amp: 0.11, waveform: 0.36, coarseTune: 0.08, fineTune: 0.54, attack: 0.22, decay: 0.64, sustain: 0.86, release: 0.82, cutoff: 0.28, resonance: 0.24, glide: 0.42, modDepth: 0.38, modRate: 0.12 }, factoryTimestamp),
    buildFactoryPreset("factory-synth-airy-pad", makeSound("tonal", 0), "Airy Pad", { amp: 0.1, waveform: 0.62, coarseTune: 0.24, fineTune: 0.58, attack: 0.26, decay: 0.56, sustain: 0.78, release: 0.88, cutoff: 0.62, resonance: 0.22, glide: 0.34, modDepth: 0.2, modRate: 0.18 }, factoryTimestamp),
    buildFactoryPreset("factory-synth-glass-tone", makeSound("tonal", 0), "Glass Tone", { amp: 0.12, waveform: 0.96, coarseTune: 0.28, fineTune: 0.62, attack: 0.01, decay: 0.36, sustain: 0.44, release: 0.36, cutoff: 0.84, resonance: 0.74, glide: 0.06, modDepth: 0.3, modRate: 0.58 }, factoryTimestamp),
    buildFactoryPreset("factory-synth-noisy-tone", makeSound("tonal", 0), "Noisy Tone", { amp: 0.11, waveform: 0.82, coarseTune: 0.88, fineTune: 0.64, attack: 0.02, decay: 0.4, sustain: 0.46, release: 0.42, cutoff: 0.72, resonance: 0.46, glide: 0.12, modDepth: 0.56, modRate: 0.52 }, factoryTimestamp),
    buildFactoryPreset("factory-synth-fm-like-tone", makeSound("tonal", 0), "FM-like Tone", { amp: 0.12, waveform: 0.56, coarseTune: 0.7, fineTune: 0.5, attack: 0.006, decay: 0.34, sustain: 0.4, release: 0.3, cutoff: 0.66, resonance: 0.48, glide: 0.08, modDepth: 0.74, modRate: 0.82 }, factoryTimestamp),
    buildFactoryPreset("factory-synth-wide-stereo-tone", makeSound("tonal", 0), "Wide Stereo Tone", { amp: 0.11, pan: 0.18, waveform: 0.66, coarseTune: 0.32, fineTune: 0.52, attack: 0.03, decay: 0.44, sustain: 0.62, release: 0.5, cutoff: 0.6, resonance: 0.34, glide: 0.82, modDepth: 0.26, modRate: 0.36 }, factoryTimestamp),
  ];
