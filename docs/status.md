...
- CTRL routing now enforces single-owner modulation per parameter, blocks self-modulation, and drives visible in-place movement on modulated controls (trigger density, drum pitch, synth cutoff) with temporary user-override while editing.
